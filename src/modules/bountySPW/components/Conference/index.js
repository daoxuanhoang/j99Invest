    ...
    <div className="conference-page">
      <div className="header mb-20">
        <div className="d-flex align-center">
          <h1>
            <FormattedMessage id="conference.title" />
          </h1>
          <p className="ml-20">
      ...
      <div className="content">
        <ul>
          <li>
            + <FormattedMessage id="conference.description.1" />
          </li>
          <li>
            + <FormattedMessage id="conference.description.2" />
          </li>
          <li>
            + <FormattedMessage id="conference.description.3" />
          </li>
          <li>
            + <FormattedMessage id="conference.description.4" />
          </li>
        </ul>
        <Form
          form={form}
